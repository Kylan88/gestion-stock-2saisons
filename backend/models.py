...
class Lot(Base):
    ...
    fitini_fe_cartons = Column(Integer, default=0)
    fitini_fe_sachets = Column(Integer, default=0)
    fitini_fe_poids_sachet = Column(Float, default=2.5)
...
class ConditionnementEntry(Base):
    ...
    fitini_fe_cartons = Column(Integer, default=0); fitini_fe_sachets = Column(Integer, default=0); fitini_fe_poids_sachet = Column(Float, default=2.5)
    responsable = Column(String(100), default="")
    notes = Column(Text, default="")
    created_at = Column(DateTime, default=datetime.now)
